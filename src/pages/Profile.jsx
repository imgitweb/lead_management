...
const Profile = () => {
  ...
  return (
    <div>
      ...
      {/* Profile Header */}
      <Card style={{ marginBottom: 24, display: 'flex', alignItems: 'center', gap: 24 }}>
        ...
        <Button variant="primary" onClick={() => setEditModal(true)} style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
